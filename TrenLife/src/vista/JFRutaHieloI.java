...
public class JFRutaHieloI extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel2.setText("TREN DEL HIELO I");
        ...
        getContentPane().add(jScrollPane1, new org.netbeans.lib.awtextra.AbsoluteConstraints(30, 70, 260, 170));
        ...
        fondo.setIcon(new javax.swing.ImageIcon(getClass().getResource("/Imagenes/fondohielo.png"))); // NOI18N
        ...
        getContentPane().add(jTextField9, new org.netbeans.lib.awtextra.AbsoluteConstraints(660, 120, -1, -1));
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(JFRutaHieloI.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new JFRutaHieloI().setVisible(true);
            }
        });
    }
