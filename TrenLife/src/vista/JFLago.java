...
public class JFLago extends javax.swing.JFrame {

    public JFLago() {
        initComponents();
        this.setLocationRelativeTo(null);
        rsscalelabel.RSScaleLabel.setScaleLabel(fondo, "src/Imagenes/lagofondo.png");
        rsscalelabel.RSScaleLabel.setScaleLabel(foto1, "src/Imagenes/lago1.png");
        rsscalelabel.RSScaleLabel.setScaleLabel(foto2, "src/Imagenes/lago2.png");
        rsscalelabel.RSScaleLabel.setScaleLabel(foto3, "src/Imagenes/lago3.png");
        rsscalelabel.RSScaleLabel.setScaleLabel(foto4, "src/Imagenes/lago4.png");
    }
    ...
    private void initComponents() {
        ...
        NOMBRE.setText("AREA NACIONAL DE RECREACION PARQUE LAGO");
        ...
        info.setColumns(20);
        info.setRows(5);
        info.setText("Es un lugar cercano a la ciudad de Guayaquil y, como \nsu nombre indica, comprende un gran lago artificial, \nproducto de un embalse sobre el río Chongón que man\ntiene una franja de vegetación a su alrededor. \nEl embalse fue construido para trasvasar agua hacia \nlos sistemas de riego y consumo humano de la península\nde Santa Elena. \nPosteriormente, con la finalidad de aprovechar el pai\nsaje originado por el embalse, se lo convirtió en un \nparque ecológico con áreas de recreación. En el área \nexisten varias especies de árboles nativos propios de \nla zona seca y semiseca de la costa como son el amarillo,\nel bálsamo y el colorado.");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(JFLago.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
