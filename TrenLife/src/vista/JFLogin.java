...
public class JFLogin extends javax.swing.JFrame {
    ...
    public JFLogin() {
        ...
        rsscalelabel.RSScaleLabel.setScaleLabel(fondologin, "src/Imagenes/fondologin.png");
    }
    ...
    private void initComponents() {
        ...
        getContentPane().add(txtUser, new org.netbeans.lib.awtextra.AbsoluteConstraints(170, 70, 150, -1));
        ...
        getContentPane().add(btnEntrar, new org.netbeans.lib.awtextra.AbsoluteConstraints(170, 160, -1, -1));

        txtPass.setFont(new java.awt.Font("Tahoma", 0, 14)); // NOI18N
        getContentPane().add(txtPass, new org.netbeans.lib.awtextra.AbsoluteConstraints(170, 110, 150, -1));
        ...
        getContentPane().add(fondologin, new org.netbeans.lib.awtextra.AbsoluteConstraints(0, 0, 400, 220));
    ...
    private void btnEntrarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnEntrarActionPerformed
        ...
        if (!txtUser.getText().equals("") && !pass.equals("")) {
            ...
            uVO.setUser(txtUser.getText());
            uVO.setPassword(nuevoPass);
            
            if (uDAO.login(uVO)) {
                JFInicio.frmLog = null;
                this.dispose();
                
                JFPruebaLogin frmMenu = new JFPruebaLogin(uVO);
