...
public class JFRutaLibertad extends javax.swing.JFrame {
  
    public JFRutaLibertad() {
        initComponents();
    ...
    private void initComponents() {
        ...
        jLabel2.setText("TREN DE LA LIBERTAD");
        ...
        getContentPane().add(jScrollPane1, new org.netbeans.lib.awtextra.AbsoluteConstraints(70, 70, 260, 170));
        ...
        getContentPane().add(jTextField6, new org.netbeans.lib.awtextra.AbsoluteConstraints(520, 240, 240, -1));

        jTextField7.setEditable(false);
        jTextField7.setText("Jueves-Viernes-Sabado-Domingo");
        getContentPane().add(jTextField7, new org.netbeans.lib.awtextra.AbsoluteConstraints(520, 200, 240, 20));

        fondo.setIcon(new javax.swing.ImageIcon(getClass().getResource("/Imagenes/fondolibertad.png"))); // NOI18N
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(JFRutaLibertad.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new JFRutaLibertad().setVisible(true);
            }
        });
    }
